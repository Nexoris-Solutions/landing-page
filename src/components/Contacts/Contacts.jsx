...
export default function Contacts() {
	...
	return (
		...
		>
			...
			<div className="flex flex-col md:flex-row gap-8 items-start w-full h-full mb-8">
				{/* Contact Form - Left */}
				<motion.form
					onSubmit={onSubmit}
				...
				<div className="w-full md:w-1/2 flex flex-col gap-4 h-full">
					<div className="bg-white border border-gray-200 rounded-xl shadow p-4 flex flex-col gap-2 h-full md:h-44">
					...
					<div className="rounded-xl overflow-hidden border border-gray-200 shadow h-64 md:h-80">
						<iframe
